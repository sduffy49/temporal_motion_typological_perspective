...
The data consists of random 200-token samples of each of the ten most frequent path and manner verbs in Spanish and in English, extracted from the Corpus del Español (Davies, 2002–), from the BYU-BNC (Davies, 2004–), and from the Corpus of Historical American English (COHA; Davies, 2010–). (See Feist & Duffy, in press, for details.) Uses encoding motion through time are highlighted in green and coded for the type of moving entity.
